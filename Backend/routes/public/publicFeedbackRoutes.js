...
import { uploadFeedbackPhoto } from "../../middleware/imageUploadMiddleware.js";
import {
  createFeedback,
...
router.post("/", uploadFeedbackPhoto, createFeedback);
router.post("/:branchSlug", uploadFeedbackPhoto, createFeedback);
